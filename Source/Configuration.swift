...
@objc public class Configuration: NSObject {
    ...
    @objc public var cancelButtonTitle = "Löschen"
    @objc public var doneButtonTitle = "Fertig"
    @objc public var noImagesTitle = "Keine Bilder verfügbar"
    @objc public var noCameraTitle = "Kamera ist nicht verfügbar"
    @objc public var settingsTitle = "Einstellungen"
    @objc public var requestPermissionTitle = "Erlaubnis verweigert"
    @objc public var requestPermissionMessage = "Bitte erlauben Sie der Anwendung den Zugriff auf Ihre Galerie"
    ...
    @objc public var albumTitle: String?
